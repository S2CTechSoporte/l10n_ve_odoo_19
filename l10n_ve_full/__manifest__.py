# -*- coding: utf-8 -*-
{
    ...
    """,
    'author': 'Juan Córdoba',
    'company': 'S2C Technology',
    'maintainer': 'Juan Córdoba',
    'website': '',
    'category': 'Localization',
    'version': '19.0.1.0.0',
    'depends': ['base_vat', 'base_address_extended', 'l10n_ve', 'contacts', 'account','account_accountant', 'account_debit_note', 'sale', 'purchase','stock', 'product'],
    'data': [
