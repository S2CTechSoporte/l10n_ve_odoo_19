...
class FiscalBookWizard(models.TransientModel):
    ...
    _description = "Asistente de libro fiscal"
    ...
    type = fields.Selection(selection=_get_type_selection, string="Tipo", required=True)
    ...
    def set_formats(self, workbook):
        ...
        merge_format_number_fcurrency = workbook.add_format({
            'bold': 0,
            'valign': 'vcenter',
        ...
        return {
            ...
            'number_fcurrency': merge_format_number_fcurrency,
...
class PurchaseBook(models.AbstractModel):
    ...
    _description = 'Reporte libro fiscal de compras'
...
class FiscalBookSaleReport(models.AbstractModel):
    ...
    _description = 'Reporte libro fiscal de ventas'
