...
class AccountInventoryBookWizard(models.TransientModel):
    ...
    def _get_product_type_filter_selection(self):
        return [
    ...
    product_type_filter = fields.Selection(
        selection=_get_product_type_filter_selection,
        string="Filtar por",
        required=True,
        default='all',
    )
...
class AccountInventoryBookReport(models.AbstractModel):
    ...
    _description = "Reporte libro de inventario"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        datos = []
        dominio_productos = ['|', ('company_id', '=', company_id.id), ('company_id', '=', False), ('is_storable', '=', True)]
        ...
        for p in productos_ids:
            ...
            if inciales_ids:
                ...
                precio_inicial = (sum(inciales_ids.mapped('value')) / existencia_inicial) if existencia_inicial > 0 else 0
