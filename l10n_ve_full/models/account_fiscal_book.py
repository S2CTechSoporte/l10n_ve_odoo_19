...
class AccountFiscalBook(models.Model):
   ...
   # company_id = fields.Many2one('res.company', 'Compañia', help='Company', )
    ...
    do_sdcf_and_exempt_sum = fields.Float(digits=(16, 2),
    ...
    get_total_with_iva_do_sum = fields.Float(
        compute='_get_total_with_iva_sum',
        store=True,
        string='Importe total con IVA',
    ...
    _period_type_company_uniq = models.Constraint(
        'UNIQUE (type,company_id,fortnight)',
...
class AdjustmentBookLine(models.Model):
    ...
    _description = 'Línea de libro de ajustes'
    ...
    type_doc = fields.Selection(TYPE_DOC, 'Tipo de Documento', required=True,
