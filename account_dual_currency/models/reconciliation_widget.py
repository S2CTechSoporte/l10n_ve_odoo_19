...
class AccountReconciliation(models.AbstractModel):
    ...
    def _prepare_move_lines(self, move_lines, target_currency=False, target_date=False, recs_count=0):
        ...
        for line in move_lines:
            ...
            debit = line.debit
            debit_fcurrency = line.debit_fcurrency
            credit = line.credit
            credit_fcurrency = line.credit_fcurrency
            amount = line.amount_residual
            amount_fcurrency = line.amount_residual_fcurrency
            amount_currency = line.amount_residual_currency

            # For already reconciled lines, don't use amount_residual(_currency)
            if line.account_id.account_type in ('asset_cash', 'liability_credit_card'):
                amount = debit - credit
                amount_fcurrency = debit_fcurrency - credit_fcurrency
            ...
            ret_line['amount_fcurrency_str'] = formatLang(self.env, abs(amount_fcurrency), currency_obj=line.company_id.fcurrency_id)
